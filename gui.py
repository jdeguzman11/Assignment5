...
class MessengerGUI:
    ...
    def _build_layout(self):
        ...
        contacts_frame = ttk.Frame(self.root, padding=5)
        contacts_frame.grid(row=0, column=0, rowspan=2, sticky="nsew")

        messages_frame = ttk.Frame(self.root, padding=5)
        ...
        self.contacts_list.grid(row=0, column=0, sticky="nsew", padx=5, pady=5)
        ...
        add_button.grid(row=2, column=0, sticky="ew", padx=5, pady=5)
        ...
        self.message_display.grid(
            row=0, column=0, sticky="nsew", padx=5, pady=5
            )

        self.message_input = tk.Text(input_frame, height=4, wrap="word")
        self.message_input.grid(row=0, column=0, sticky="nsew", padx=5, pady=5)
